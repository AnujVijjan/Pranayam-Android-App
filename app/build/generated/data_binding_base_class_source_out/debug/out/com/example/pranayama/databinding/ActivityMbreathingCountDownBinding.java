...
public final class ActivityMbreathingCountDownBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMbreathingCountDownBinding(@NonNull LinearLayout rootView, @NonNull TextView hr,
  ...
  @NonNull
  public static ActivityMbreathingCountDownBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMbreathingCountDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_mbreathing_count_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMbreathingCountDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMbreathingCountDownBinding((LinearLayout) rootView, hr, info, infoTime,

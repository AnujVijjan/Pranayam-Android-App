...
public final class ActivityBhastrikaCountDownBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBhastrikaCountDownBinding(@NonNull LinearLayout rootView, @NonNull TextView hr,
  ...
  @NonNull
  public static ActivityBhastrikaCountDownBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBhastrikaCountDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bhastrika_count_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBhastrikaCountDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBhastrikaCountDownBinding((LinearLayout) rootView, hr, info, infoTime, min,

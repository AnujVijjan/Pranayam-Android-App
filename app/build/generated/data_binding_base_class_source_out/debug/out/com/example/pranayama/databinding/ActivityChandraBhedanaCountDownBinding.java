...
public final class ActivityChandraBhedanaCountDownBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityChandraBhedanaCountDownBinding(@NonNull LinearLayout rootView,
      @NonNull TextView hr, @NonNull TextView info, @NonNull TextView infoTime,
      @NonNull TextView min, @NonNull ImageView pranayamcurrentpose, @NonNull TextView sec,
  ...
  @NonNull
  public static ActivityChandraBhedanaCountDownBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityChandraBhedanaCountDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_chandra_bhedana_count_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityChandraBhedanaCountDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChandraBhedanaCountDownBinding((LinearLayout) rootView, hr, info, infoTime,

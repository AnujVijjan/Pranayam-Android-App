...
public final class ActivityCountDownBinding implements ViewBinding {
  ...
  private ActivityCountDownBinding(@NonNull LinearLayout rootView, @NonNull TextView hr,
  ...
  public static ActivityCountDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_count_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityCountDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCountDownBinding((LinearLayout) rootView, hr, info, infoTime, min,

...
public final class NavHeaderMainBinding implements ViewBinding {
  ...
  private NavHeaderMainBinding(@NonNull ConstraintLayout rootView, @NonNull GifImageView imageView,
  ...
  public static NavHeaderMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.imageView;
      GifImageView imageView = rootView.findViewById(id);
      if (imageView == null) {
        break missingId;
      }
      ...
      return new NavHeaderMainBinding((ConstraintLayout) rootView, imageView, textView, textView2);
    }

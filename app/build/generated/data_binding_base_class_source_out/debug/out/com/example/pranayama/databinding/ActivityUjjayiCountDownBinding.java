...
public final class ActivityUjjayiCountDownBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityUjjayiCountDownBinding(@NonNull LinearLayout rootView, @NonNull TextView hr,
  ...
  @NonNull
  public static ActivityUjjayiCountDownBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUjjayiCountDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ujjayi_count_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUjjayiCountDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUjjayiCountDownBinding((LinearLayout) rootView, hr, info, infoTime, min,

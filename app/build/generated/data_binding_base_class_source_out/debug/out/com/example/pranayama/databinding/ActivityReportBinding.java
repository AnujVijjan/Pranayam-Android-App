...
public final class ActivityReportBinding implements ViewBinding {
  ...
  private ActivityReportBinding(@NonNull ScrollView rootView, @NonNull LinearLayout records) {
  ...
  public static ActivityReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.records;
      LinearLayout records = rootView.findViewById(id);
      if (records == null) {
        break missingId;
      }

      return new ActivityReportBinding((ScrollView) rootView, records);
    }

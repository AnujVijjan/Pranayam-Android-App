...
public final class ActivityKapalbhatiCountDownBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityKapalbhatiCountDownBinding(@NonNull LinearLayout rootView, @NonNull TextView hr,
  ...
  @NonNull
  public static ActivityKapalbhatiCountDownBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityKapalbhatiCountDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_kapalbhati_count_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityKapalbhatiCountDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityKapalbhatiCountDownBinding((LinearLayout) rootView, hr, info, infoTime,

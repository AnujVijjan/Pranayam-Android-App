...
public final class ActivitySheetaliCountDownBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySheetaliCountDownBinding(@NonNull LinearLayout rootView, @NonNull TextView hr,
  ...
  @NonNull
  public static ActivitySheetaliCountDownBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySheetaliCountDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_sheetali_count_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySheetaliCountDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySheetaliCountDownBinding((LinearLayout) rootView, hr, info, infoTime, min,
